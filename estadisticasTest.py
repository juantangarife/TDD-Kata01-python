...
class estadisticasTest(TestCase):
    def test_getEstadisticas_vacia(self):
        ...
        self.assertEquals(estadistica[1], None, "Cadena vacia - Mínimo")
        self.assertEquals(estadistica[2], None, "Cadena vacia - Máximo")
    ...
    def test_getEstadisticas_NNumeros(self):
        ...
        self.assertEquals(estadistica[1],2,"Con N numeros - Minimo")
